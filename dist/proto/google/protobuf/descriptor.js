...
exports.FileDescriptorProto = {
    ...
    fromJSON(object) {
        return {
            ...
            weak_dependency: globalThis.Array.isArray(object?.weak_dependency)
                ...
                : [],
            option_dependency: globalThis.Array.isArray(object?.option_dependency)
    ...
    toJSON(message) {
        ...
        if (message.option_dependency?.length) {
            obj.option_dependency = message.option_dependency;
        }
...
exports.FieldOptions = {
    ...
    toJSON(message) {
        ...
        if (message.edition_defaults?.length) {
            obj.edition_defaults = message.edition_defaults.map((e) => exports.FieldOptions_EditionDefault.toJSON(e));
        }
        if (message.features !== undefined) {
            obj.features = exports.FeatureSet.toJSON(message.features);
        }
        if (message.feature_support !== undefined) {
            obj.feature_support = exports.FieldOptions_FeatureSupport.toJSON(message.feature_support);
        }
        if (message.uninterpreted_option?.length) {
            obj.uninterpreted_option = message.uninterpreted_option.map((e) => exports.UninterpretedOption.toJSON(e));
        }
...
exports.FeatureSet = {
    ...
    fromJSON(object) {
        return {
            ...
            enforce_naming_style: isSet(object.enforce_naming_style)
                ...
                : 0,
            default_symbol_visibility: isSet(object.default_symbol_visibility)
    ...
    toJSON(message) {
        ...
        if (message.enforce_naming_style !== undefined && message.enforce_naming_style !== 0) {
            obj.enforce_naming_style = featureSet_EnforceNamingStyleToJSON(message.enforce_naming_style);
        }
        if (message.default_symbol_visibility !== undefined && message.default_symbol_visibility !== 0) {
            obj.default_symbol_visibility = featureSet_VisibilityFeature_DefaultSymbolVisibilityToJSON(message.default_symbol_visibility);
        }
        return obj;
    },
    create(base) {
    ...
    fromJSON(object) {
        return {
            ...
            overridable_features: isSet(object.overridable_features)
                ...
                : undefined,
            fixed_features: isSet(object.fixed_features) ? exports.FeatureSet.fromJSON(object.fixed_features) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.overridable_features !== undefined) {
            obj.overridable_features = exports.FeatureSet.toJSON(message.overridable_features);
        }
        if (message.fixed_features !== undefined) {
            obj.fixed_features = exports.FeatureSet.toJSON(message.fixed_features);
        }
        return obj;
    },
    create(base) {
