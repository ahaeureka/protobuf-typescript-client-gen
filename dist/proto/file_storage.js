...
exports.UploadFileResponse = {
    ...
    fromJSON(object) {
        return {
            file_info: isSet(object.file_info) ? exports.FileInfo.fromJSON(object.file_info) : undefined,
            callback_result: isSet(object.callback_result) ? exports.CallbackResult.fromJSON(object.callback_result) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        if (message.file_info !== undefined) {
            obj.file_info = exports.FileInfo.toJSON(message.file_info);
        }
        if (message.callback_result !== undefined) {
            obj.callback_result = exports.CallbackResult.toJSON(message.callback_result);
        }
        return obj;
    },
    create(base) {
...
exports.GetUploadStatusResponse = {
    ...
    toJSON(message) {
        ...
        if (message.completed_parts?.length) {
            obj.completed_parts = message.completed_parts.map((e) => exports.UploadedPartInfo.toJSON(e));
        }
        if (message.total_parts !== 0) {
            obj.total_parts = Math.round(message.total_parts);
        }
