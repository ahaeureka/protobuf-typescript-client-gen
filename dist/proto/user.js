...
exports.BasicAuth = {
    ...
    fromJSON(object) {
        return {
            ...
            not_before: isSet(object.nbf) ? globalThis.Number(object.nbf) : 0,
            expiration: isSet(object.exp) ? globalThis.Number(object.exp) : 0,
            issued_at: isSet(object.iat) ? globalThis.Number(object.iat) : 0,
...
exports.PostUserRequest = {
    ...
    fromJSON(object) {
        return {
            ...
            update_mask: isSet(object.update_mask) ? field_mask_1.FieldMask.unwrap(field_mask_1.FieldMask.fromJSON(object.update_mask)) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.update_mask !== undefined) {
            obj.update_mask = field_mask_1.FieldMask.toJSON(field_mask_1.FieldMask.wrap(message.update_mask));
        }
        return obj;
    },
    create(base) {
...
exports.UploadAvatarRequest = {
    ...
    fromJSON(object) {
        return {
            avatar_data: isSet(object.avatar_data) ? bytesFromBase64(object.avatar_data) : new Uint8Array(0),
    ...
    toJSON(message) {
        const obj = {};
        if (message.avatar_data.length !== 0) {
            obj.avatar_data = base64FromBytes(message.avatar_data);
        }
        if (message.filename !== "") {
...
exports.UploadAvatarResponse = {
    ...
    fromJSON(object) {
        return { avatar_url: isSet(object.avatar_url) ? globalThis.String(object.avatar_url) : "" };
    },
    toJSON(message) {
        const obj = {};
        if (message.avatar_url !== "") {
