...
class V1Client {
    ...
    async get_audit_logs(request, headers) {
        ...
        if (isAPIResponse(response.data)) {
            ...
            if (response.data.data !== undefined) {
                ...
                if (userData && typeof userData === 'object' && 'user' in userData) {
                    console.log('[AuditService] Extracting user from nested structure:', userData.user);
                    return audit_1.GetAuditLogsResponse.fromJSON(userData.user);
                }
                console.log('[AuditService] Using data directly as GetAuditLogsResponse:', userData);
                return audit_1.GetAuditLogsResponse.fromJSON(userData);
            }
            // Direct response (APIResponse but without data field - shouldn't normally happen)
            console.log('[AuditService] Using response.data directly as GetAuditLogsResponse:', response.data);
            return audit_1.GetAuditLogsResponse.fromJSON(response.data);
        }
        // Not an APIResponse - treat as direct protobuf response
        console.log('[AuditService] Using response directly as GetAuditLogsResponse (non-wrapped):', response.data);
        return audit_1.GetAuditLogsResponse.fromJSON(response.data);
    }
    async get_audit_statistics(request, headers) {
        // Extract and replace path parameters (supports nested fields like {service.service_name})
        ...
        if (isAPIResponse(response.data)) {
            ...
            if (response.data.data !== undefined) {
                ...
                if (userData && typeof userData === 'object' && 'user' in userData) {
                    console.log('[AuditService] Extracting user from nested structure:', userData.user);
                    return audit_1.GetAuditStatisticsResponse.fromJSON(userData.user);
                }
                console.log('[AuditService] Using data directly as GetAuditStatisticsResponse:', userData);
                return audit_1.GetAuditStatisticsResponse.fromJSON(userData);
            }
            // Direct response (APIResponse but without data field - shouldn't normally happen)
            console.log('[AuditService] Using response.data directly as GetAuditStatisticsResponse:', response.data);
            return audit_1.GetAuditStatisticsResponse.fromJSON(response.data);
        }
        // Not an APIResponse - treat as direct protobuf response
        console.log('[AuditService] Using response directly as GetAuditStatisticsResponse (non-wrapped):', response.data);
        return audit_1.GetAuditStatisticsResponse.fromJSON(response.data);
    }
}
