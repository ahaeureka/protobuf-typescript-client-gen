...
const billing_1 = require("./stew/api/v1/billing");
...
exports.GetServiceInstancesRequest = {
    ...
    fromJSON(object) {
        return {
            ...
            tag_filters: isObject(object.tag_filters)
                ? Object.entries(object.tag_filters).reduce((acc, [key, value]) => {
                    acc[key] = String(value);
                    return acc;
                }, {})
                : {},
    ...
    fromPartial(object) {
        const message = createBaseGetServiceInstancesRequest();
        message.service_name = object.service_name ?? "";
        message.tag_filters = Object.entries(object.tag_filters ?? {}).reduce((acc, [key, value]) => {
            if (value !== undefined) {
                acc[key] = globalThis.String(value);
            }
            return acc;
