...
function createBaseServiceSubscriptionConfig() {
    return {
        enabled: false,
        business_id: "",
        default_plan_id: "",
...
exports.ServiceSubscriptionConfig = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.enabled !== false) {
            writer.uint32(8).bool(message.enabled);
        }
        ...
        globalThis.Object.entries(message.endpoint_features).forEach(([key, value]) => {
            exports.ServiceSubscriptionConfig_EndpointFeaturesEntry.encode({ key: key, value }, writer.uint32(74).fork())
                .join();
        });
        return writer;
    },
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 9: {
                    ...
                    const entry9 = exports.ServiceSubscriptionConfig_EndpointFeaturesEntry.decode(reader, reader.uint32());
    ...
    fromJSON(object) {
        return {
            ...
            endpoint_features: isObject(object.endpoint_features)
                ? globalThis.Object.entries(object.endpoint_features).reduce((acc, [key, value]) => {
    ...
    toJSON(message) {
        ...
        if (message.endpoint_features) {
            const entries = globalThis.Object.entries(message.endpoint_features);
            if (entries.length > 0) {
    ...
    create(base) {
        return exports.ServiceSubscriptionConfig.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseServiceSubscriptionConfig();
        message.enabled = object.enabled ?? false;
        ...
        message.endpoint_features = globalThis.Object.entries(object.endpoint_features ?? {})
...
function createBaseServiceSubscriptionConfig_EndpointFeaturesEntry() {
    return { key: "", value: "" };
}
exports.ServiceSubscriptionConfig_EndpointFeaturesEntry = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.key !== "") {
    ...
    create(base) {
        return exports.ServiceSubscriptionConfig_EndpointFeaturesEntry.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseServiceSubscriptionConfig_EndpointFeaturesEntry();
...
exports.ServiceMiddlewareConfig = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.billing !== undefined) {
            billing_1.ServiceBillingConfig.encode(message.billing, writer.uint32(410).fork()).join();
        }
        if (message.subscription_enabled !== false) {
            writer.uint32(480).bool(message.subscription_enabled);
        }
        if (message.subscription !== undefined) {
            exports.ServiceSubscriptionConfig.encode(message.subscription, writer.uint32(490).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 51: {
                    ...
                    message.billing = billing_1.ServiceBillingConfig.decode(reader, reader.uint32());
                    continue;
                }
                case 60: {
                    if (tag !== 480) {
                ...
                case 61: {
                    ...
                    message.subscription = exports.ServiceSubscriptionConfig.decode(reader, reader.uint32());
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object) {
        return {
            ...
            billing: isSet(object.billing) ? billing_1.ServiceBillingConfig.fromJSON(object.billing) : undefined,
            subscription_enabled: isSet(object.subscription_enabled)
                ? globalThis.Boolean(object.subscription_enabled)
                : false,
            subscription: isSet(object.subscription) ? exports.ServiceSubscriptionConfig.fromJSON(object.subscription) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.billing !== undefined) {
            obj.billing = billing_1.ServiceBillingConfig.toJSON(message.billing);
        }
        if (message.subscription_enabled !== false) {
            obj.subscription_enabled = message.subscription_enabled;
        }
        if (message.subscription !== undefined) {
            obj.subscription = exports.ServiceSubscriptionConfig.toJSON(message.subscription);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.billing = (object.billing !== undefined && object.billing !== null)
            ? billing_1.ServiceBillingConfig.fromPartial(object.billing)
            : undefined;
        message.subscription_enabled = object.subscription_enabled ?? false;
        message.subscription = (object.subscription !== undefined && object.subscription !== null)
            ? exports.ServiceSubscriptionConfig.fromPartial(object.subscription)
            : undefined;
        return message;
    },
};
