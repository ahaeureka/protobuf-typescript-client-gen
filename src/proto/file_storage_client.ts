...
private getToken(): string | null {
  ...
  async upload_file(
    inputStream: AsyncIterable<UploadFileRequest>,
    ...
    return new Promise(async (resolve, reject) => {
      ...
      const onMessage = (event: MessageEvent) => {
        try {
          const result = processWebSocketMessage<UploadFileResponse>(
            event,
            UploadFileResponse,
            false
          );
    ...
    if (isAPIResponse(response.data)) {
      ...
      if (response.data.data !== undefined) {
        ...
        if (userData && typeof userData === 'object' && 'user' in userData) {
          ...
          return InitResumableUploadResponse.fromJSON(userData.user);
        }

        console.log('[FileStorageService] Using data directly as InitResumableUploadResponse:', userData);
        return InitResumableUploadResponse.fromJSON(userData);
      }
      ...
      return InitResumableUploadResponse.fromJSON(response.data);
    }
  ...
  async upload_part(
    inputStream: AsyncIterable<UploadPartRequest>,
    headers?: Record<string, string>
    ...
    return new Promise(async (resolve, reject) => {
      ...
      const onMessage = (event: MessageEvent) => {
        try {
          const result = processWebSocketMessage<UploadPartResponse>(
            event,
            UploadPartResponse,
            false
          );
  ...
  async complete_resumable_upload(
    request: CompleteResumableUploadRequest,
    headers?: Record<string, string>
  ): Promise<UploadFileResponse> {
    // Extract and replace path parameters (supports nested fields like {service.service_name})
    ...
    if (isAPIResponse(response.data)) {
      ...
      if (response.data.data !== undefined) {
        ...
        if (userData && typeof userData === 'object' && 'user' in userData) {
          console.log('[FileStorageService] Extracting user from nested structure:', userData.user);
          return UploadFileResponse.fromJSON(userData.user);
        }

        console.log('[FileStorageService] Using data directly as UploadFileResponse:', userData);
        return UploadFileResponse.fromJSON(userData);
      }
      // Direct response (APIResponse but without data field - shouldn't normally happen)
  ...
  async abort_resumable_upload(
    request: AbortResumableUploadRequest,
    headers?: Record<string, string>
  ): Promise<Empty> {
    // Extract and replace path parameters (supports nested fields like {service.service_name})
  ...
  async get_file_info(
    ...
    if (isAPIResponse(response.data)) {
      ...
      if (response.data.data !== undefined) {
        ...
        if (userData && typeof userData === 'object' && 'user' in userData) {
          console.log('[FileStorageService] Extracting user from nested structure:', userData.user);
          return FileInfo.fromJSON(userData.user);
        }

        console.log('[FileStorageService] Using data directly as FileInfo:', userData);
        return FileInfo.fromJSON(userData);
      }
      // Direct response (APIResponse but without data field - shouldn't normally happen)
  ...
  async get_path_info(
    request: GetPathInfoRequest,
    headers?: Record<string, string>
  ): Promise<GetPathInfoResponse> {
    // Extract and replace path parameters (supports nested fields like {service.service_name})
