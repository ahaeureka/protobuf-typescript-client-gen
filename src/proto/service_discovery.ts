...
export interface ServiceSubscriptionConfig {
  ...
  endpoint_features: { [key: string]: string };
}
...
function createBaseServiceSubscriptionConfig(): ServiceSubscriptionConfig {
  return {
    enabled: false,
    business_id: "",
    default_plan_id: "",
...
export const ServiceSubscriptionConfig: MessageFns<ServiceSubscriptionConfig> = {
  encode(message: ServiceSubscriptionConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.enabled !== false) {
      writer.uint32(8).bool(message.enabled);
    }
    ...
    if (message.default_plan_id !== "") {
      writer.uint32(26).string(message.default_plan_id);
    }
    if (message.auto_create_subscription !== false) {
      writer.uint32(32).bool(message.auto_create_subscription);
    }
    if (message.inject_features !== false) {
      writer.uint32(40).bool(message.inject_features);
    }
    if (message.inject_quotas !== false) {
      writer.uint32(48).bool(message.inject_quotas);
    }
    if (message.feature_gate_mode !== "") {
      writer.uint32(58).string(message.feature_gate_mode);
    }
    if (message.require_active_subscription !== false) {
      writer.uint32(64).bool(message.require_active_subscription);
    }
    globalThis.Object.entries(message.endpoint_features).forEach(([key, value]: [string, string]) => {
      ServiceSubscriptionConfig_EndpointFeaturesEntry.encode({ key: key as any, value }, writer.uint32(74).fork())
        .join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ServiceSubscriptionConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseServiceSubscriptionConfig();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 3: {
          ...
          message.default_plan_id = reader.string();
          continue;
        }
        case 4: {
          if (tag !== 32) {
          ...
          message.auto_create_subscription = reader.bool();
          continue;
        }
        case 5: {
          if (tag !== 40) {
          ...
          message.inject_features = reader.bool();
          continue;
        }
        case 6: {
          if (tag !== 48) {
          ...
          message.inject_quotas = reader.bool();
          continue;
        }
        case 7: {
          if (tag !== 58) {
          ...
          message.feature_gate_mode = reader.string();
          continue;
        }
        case 8: {
          if (tag !== 64) {
          ...
          message.require_active_subscription = reader.bool();
          continue;
        }
        case 9: {
          if (tag !== 74) {
          ...
          const entry9 = ServiceSubscriptionConfig_EndpointFeaturesEntry.decode(reader, reader.uint32());
          if (entry9.value !== undefined) {
            message.endpoint_features[entry9.key] = entry9.value;
          }
          continue;
        }
      }
  ...
  fromJSON(object: any): ServiceSubscriptionConfig {
    return {
      enabled: isSet(object.enabled) ? globalThis.Boolean(object.enabled) : false,
      business_id: isSet(object.business_id) ? globalThis.String(object.business_id) : "",
      default_plan_id: isSet(object.default_plan_id) ? globalThis.String(object.default_plan_id) : "",
      auto_create_subscription: isSet(object.auto_create_subscription)
        ? globalThis.Boolean(object.auto_create_subscription)
        : false,
      inject_features: isSet(object.inject_features) ? globalThis.Boolean(object.inject_features) : false,
      inject_quotas: isSet(object.inject_quotas) ? globalThis.Boolean(object.inject_quotas) : false,
      feature_gate_mode: isSet(object.feature_gate_mode) ? globalThis.String(object.feature_gate_mode) : "",
      require_active_subscription: isSet(object.require_active_subscription)
        ? globalThis.Boolean(object.require_active_subscription)
        : false,
      endpoint_features: isObject(object.endpoint_features)
        ? (globalThis.Object.entries(object.endpoint_features) as [string, any][]).reduce(
  ...
  toJSON(message: ServiceSubscriptionConfig): unknown {
    const obj: any = {};
    if (message.enabled !== false) {
      obj.enabled = message.enabled;
    }
    ...
    if (message.default_plan_id !== "") {
      obj.default_plan_id = message.default_plan_id;
    }
    if (message.auto_create_subscription !== false) {
      obj.auto_create_subscription = message.auto_create_subscription;
    }
    if (message.inject_features !== false) {
      obj.inject_features = message.inject_features;
    }
    if (message.inject_quotas !== false) {
      obj.inject_quotas = message.inject_quotas;
    }
    if (message.feature_gate_mode !== "") {
      obj.feature_gate_mode = message.feature_gate_mode;
    }
    if (message.require_active_subscription !== false) {
      obj.require_active_subscription = message.require_active_subscription;
    }
    if (message.endpoint_features) {
      const entries = globalThis.Object.entries(message.endpoint_features) as [string, string][];
      if (entries.length > 0) {
        obj.endpoint_features = {};
        entries.forEach(([k, v]) => {
          obj.endpoint_features[k] = v;
        });
      }
    }
    return obj;
  ...
  create<I extends Exact<DeepPartial<ServiceSubscriptionConfig>, I>>(base?: I): ServiceSubscriptionConfig {
    return ServiceSubscriptionConfig.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ServiceSubscriptionConfig>, I>>(object: I): ServiceSubscriptionConfig {
    const message = createBaseServiceSubscriptionConfig();
    message.enabled = object.enabled ?? false;
    message.business_id = object.business_id ?? "";
    message.default_plan_id = object.default_plan_id ?? "";
    message.auto_create_subscription = object.auto_create_subscription ?? false;
    message.inject_features = object.inject_features ?? false;
    message.inject_quotas = object.inject_quotas ?? false;
    message.feature_gate_mode = object.feature_gate_mode ?? "";
    message.require_active_subscription = object.require_active_subscription ?? false;
    message.endpoint_features = (globalThis.Object.entries(object.endpoint_features ?? {}) as [string, string][])
...
function createBaseServiceSubscriptionConfig_EndpointFeaturesEntry(): ServiceSubscriptionConfig_EndpointFeaturesEntry {
  return { key: "", value: "" };
}

export const ServiceSubscriptionConfig_EndpointFeaturesEntry: MessageFns<
  ServiceSubscriptionConfig_EndpointFeaturesEntry
> = {
  encode(
    message: ServiceSubscriptionConfig_EndpointFeaturesEntry,
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ServiceSubscriptionConfig_EndpointFeaturesEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseServiceSubscriptionConfig_EndpointFeaturesEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): ServiceSubscriptionConfig_EndpointFeaturesEntry {
    return {
  ...
  toJSON(message: ServiceSubscriptionConfig_EndpointFeaturesEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
  ...
  create<I extends Exact<DeepPartial<ServiceSubscriptionConfig_EndpointFeaturesEntry>, I>>(
    base?: I,
  ): ServiceSubscriptionConfig_EndpointFeaturesEntry {
    return ServiceSubscriptionConfig_EndpointFeaturesEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ServiceSubscriptionConfig_EndpointFeaturesEntry>, I>>(
    object: I,
  ): ServiceSubscriptionConfig_EndpointFeaturesEntry {
    const message = createBaseServiceSubscriptionConfig_EndpointFeaturesEntry();
...
export const ServiceMiddlewareConfig: MessageFns<ServiceMiddlewareConfig> = {
  encode(message: ServiceMiddlewareConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.subscription_enabled !== false) {
      writer.uint32(480).bool(message.subscription_enabled);
    }
    if (message.subscription !== undefined) {
      ServiceSubscriptionConfig.encode(message.subscription, writer.uint32(490).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 60: {
          ...
          message.subscription_enabled = reader.bool();
          continue;
        }
        case 61: {
          if (tag !== 490) {
          ...
          message.subscription = ServiceSubscriptionConfig.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ServiceMiddlewareConfig {
    return {
      ...
      subscription_enabled: isSet(object.subscription_enabled)
        ? globalThis.Boolean(object.subscription_enabled)
        : false,
      subscription: isSet(object.subscription) ? ServiceSubscriptionConfig.fromJSON(object.subscription) : undefined,
    };
  },
  ...
  toJSON(message: ServiceMiddlewareConfig): unknown {
    ...
    if (message.subscription_enabled !== false) {
      obj.subscription_enabled = message.subscription_enabled;
    }
    if (message.subscription !== undefined) {
      obj.subscription = ServiceSubscriptionConfig.toJSON(message.subscription);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ServiceMiddlewareConfig>, I>>(object: I): ServiceMiddlewareConfig {
    ...
    message.billing = (object.billing !== undefined && object.billing !== null)
      ...
      : undefined;
    message.subscription_enabled = object.subscription_enabled ?? false;
    message.subscription = (object.subscription !== undefined && object.subscription !== null)
      ? ServiceSubscriptionConfig.fromPartial(object.subscription)
      : undefined;
    return message;
  },
};
...
export const ServiceInstance: MessageFns<ServiceInstance> = {
  encode(message: ServiceInstance, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.metadata).forEach(([key, value]: [string, Any]) => {
  ...
  toJSON(message: ServiceInstance): unknown {
    ...
    if (message.metadata) {
      const entries = globalThis.Object.entries(message.metadata) as [string, Any][];
      if (entries.length > 0) {
        obj.metadata = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<ServiceInstance>, I>>(object: I): ServiceInstance {
    ...
    message.metadata = (globalThis.Object.entries(object.metadata ?? {}) as [string, Any][]).reduce(
      (acc: { [key: string]: Any }, [key, value]: [string, Any]) => {
        if (value !== undefined) {
