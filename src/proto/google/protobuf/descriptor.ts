...
export const FileDescriptorProto: MessageFns<FileDescriptorProto> = {
  ...
  toJSON(message: FileDescriptorProto): unknown {
    ...
    if (message.message_type?.length) {
      obj.messageType = message.message_type.map((e) => DescriptorProto.toJSON(e));
    }
    if (message.enum_type?.length) {
      obj.enumType = message.enum_type.map((e) => EnumDescriptorProto.toJSON(e));
    }
    ...
    if (message.source_code_info !== undefined) {
      obj.sourceCodeInfo = SourceCodeInfo.toJSON(message.source_code_info);
    }
    if (message.syntax !== undefined && message.syntax !== "") {
...
export const DescriptorProto: MessageFns<DescriptorProto> = {
  ...
  toJSON(message: DescriptorProto): unknown {
    ...
    if (message.nested_type?.length) {
      obj.nestedType = message.nested_type.map((e) => DescriptorProto.toJSON(e));
    }
    if (message.enum_type?.length) {
      obj.enumType = message.enum_type.map((e) => EnumDescriptorProto.toJSON(e));
    }
    if (message.extension_range?.length) {
      obj.extensionRange = message.extension_range.map((e) => DescriptorProto_ExtensionRange.toJSON(e));
    }
    if (message.oneof_decl?.length) {
      obj.oneofDecl = message.oneof_decl.map((e) => OneofDescriptorProto.toJSON(e));
    }
    if (message.options !== undefined) {
      obj.options = MessageOptions.toJSON(message.options);
    }
    if (message.reserved_range?.length) {
      obj.reservedRange = message.reserved_range.map((e) => DescriptorProto_ReservedRange.toJSON(e));
    }
...
export const ExtensionRangeOptions: MessageFns<ExtensionRangeOptions> = {
  ...
  toJSON(message: ExtensionRangeOptions): unknown {
    ...
    if (message.uninterpreted_option?.length) {
      obj.uninterpretedOption = message.uninterpreted_option.map((e) => UninterpretedOption.toJSON(e));
    }
...
export const EnumDescriptorProto: MessageFns<EnumDescriptorProto> = {
  ...
  toJSON(message: EnumDescriptorProto): unknown {
    ...
    if (message.reserved_range?.length) {
      obj.reservedRange = message.reserved_range.map((e) => EnumDescriptorProto_EnumReservedRange.toJSON(e));
    }
    if (message.reserved_name?.length) {
      obj.reservedName = message.reserved_name;
    }
...
export const FieldOptions: MessageFns<FieldOptions> = {
  ...
  toJSON(message: FieldOptions): unknown {
    ...
    if (message.edition_defaults?.length) {
      obj.editionDefaults = message.edition_defaults.map((e) => FieldOptions_EditionDefault.toJSON(e));
    }
    if (message.features !== undefined) {
      obj.features = FeatureSet.toJSON(message.features);
    }
    if (message.feature_support !== undefined) {
      obj.featureSupport = FieldOptions_FeatureSupport.toJSON(message.feature_support);
    }
    if (message.uninterpreted_option?.length) {
      obj.uninterpretedOption = message.uninterpreted_option.map((e) => UninterpretedOption.toJSON(e));
    }
  ...
  toJSON(message: FeatureSet): unknown {
    ...
    if (message.default_symbol_visibility !== undefined && message.default_symbol_visibility !== 0) {
      obj.defaultSymbolVisibility = featureSet_VisibilityFeature_DefaultSymbolVisibilityToJSON(
        message.default_symbol_visibility,
      );
    }
    return obj;
  },
...
export const FeatureSetDefaults_FeatureSetEditionDefault: MessageFns<FeatureSetDefaults_FeatureSetEditionDefault> = {
  ...
  toJSON(message: FeatureSetDefaults_FeatureSetEditionDefault): unknown {
    ...
    if (message.overridable_features !== undefined) {
      obj.overridableFeatures = FeatureSet.toJSON(message.overridable_features);
    }
    if (message.fixed_features !== undefined) {
      obj.fixedFeatures = FeatureSet.toJSON(message.fixed_features);
    }
    return obj;
  },
